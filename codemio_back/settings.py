...
ANALYSIS_MAX_EXTRACTED_FILE_BYTES = config('ANALYSIS_MAX_EXTRACTED_FILE_BYTES', default=5242880, cast=int)
ANALYSIS_MAX_COMPRESSION_RATIO = config('ANALYSIS_MAX_COMPRESSION_RATIO', default=200, cast=int)
